...
class SegmentationCompressor(object):
    ...
    def __init__(self, args, script_dir):
        ...
        self.criterion = apputils.loss.DiceLoss().to(self.args.device)
...
def init_segmentation_compression_arg_parser(include_ptq_lapq_args=False):
...
def test(test_loader, model, criterion, loggers=None, activations_collectors=None, args=None):
    ...
    msglogger.info('--- test ---------------------')
    if args is None:
        args = SegmentationCompressor.mock_args()
